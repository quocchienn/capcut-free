...
export default function Home() {
  ...
  const accounts = [
    ...
    {
      link: "https://link4m.com/He5lFz0d",
      description: t("account.premium", language),
      updatedAt: "2 mins ago",
      accessCount: 45,
      category: "capcut" as const,
    ...
    {
      link: "https://link4m.com/pXkfpH6v",
      description: t("account.premium", language),
      updatedAt: "2 mins ago",
      accessCount: 45,
      category: "capcut" as const,
