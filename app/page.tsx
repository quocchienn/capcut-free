...
export default function Home() {
  ...
  const accounts = [
    ...
    {
      Link: "furman.weber@hunght1890.com",
    ...
    {
      Link: "https://www.canva.com/brand/join?token=RpjPNBzjPhA15I7pwoqt_w&referrer=team-invite",
    ...
    {
      Link: "https://www.canva.com/brand/join?token=dO-Hz3Am5OzDP53vkq7jLg&referrer=team-invite",
      description: t("account.teamcanva", language),
      updatedAt: "1 hour ago",
      accessCount: 18,
      category: "team" as const,
